...
class OzpaParser
{
    ...
    public function __construct($filename,$discount)
    {
        ...
        $this->varianceFields = ["StokKodu","EkSecenekOzellik/Ozellik[@Tanim='Renk']", "EkSecenekOzellik/Ozellik[@Tanim='Beden']","AlisFiyati","SatisFiyati", "StokAdedi"];
    ...
    function parse()
    {
        ...
        $response = Parser::curlRequest('https://www.ozpa.com/TicimaxCustomXml/535E2456167E47F5B65FDB36A3918641/');
